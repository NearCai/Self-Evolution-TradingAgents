...
class TradingAgentsGraph:
    ...
    def _fetch_returns(
        ...
        ``as_of_date`` is for historical simulations: when set, data after that
        ...
        try:
            ...
            if as_of_date and (len(stock) <= holding_days or len(bench) <= holding_days):
                return None, None, None
    ...
    def _resolve_pending_entries(self, ticker: str, current_trade_date: str | None = None) -> None:
        ...
        holding_days = int(cfg.get("memory_outcome_holding_days", 5))
        as_of_date = current_trade_date if cfg.get("memory_lookahead_safe") else None
    ...
    def propagate(self, company_name, trade_date, asset_type: str = "stock"):
        ...
        self._resolve_pending_entries(company_name, current_trade_date=str(trade_date))
    ...
    def _run_graph(self, company_name, trade_date, asset_type: str = "stock"):
        ...
        if self.config.get("memory_lookahead_safe"):
